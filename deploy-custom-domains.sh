...
# RAMA Chat App - Custom Domains AWS EC2 Deployment Script
# ========================================================

set -e  # Exit on any error

echo "🚀 Starting RAMA Chat App Deployment with Custom Domains..."
...
print_success "🎉 Custom Domains Deployment completed successfully!"
...
echo "2. Ensure your DNS records point to this EC2 instance:"
echo "   - chat.d0s369.co.in -> Your EC2 Public IP"
echo "   - c.d0s369.co.in -> Your EC2 Public IP"
echo "3. The application is running with PM2 - use 'pm2 status' to check status"
echo "4. Logs are available in /var/www/rama-chat/backend/logs/"
echo "5. To restart the application: pm2 restart rama-chat-backend"
echo "6. To view logs: pm2 logs rama-chat-backend"

print_status "Custom domains deployment script completed!"
